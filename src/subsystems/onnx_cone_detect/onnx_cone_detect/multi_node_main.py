#!/usr/bin/env python3
"""Mission launcher for onnx_cone_detect.

Detection and tracking nodes run in this process while overall vehicle control
is delegated to ``control_main.py``.  Once that script terminates (e.g. after an
EBS event) the mission selection is shown again.
"""
