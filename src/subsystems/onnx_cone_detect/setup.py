# src/subsystems/onnx_cone_detect/setup.py
import os
...
setup(
    ...
    install_requires=['setuptools', 'sort_tracking', 'art_slam', 'path_viz'],
    zip_safe=True,
    ...
    entry_points={
        'console_scripts': [
            ...
            'watchdog_node = onnx_cone_detect.watchdog_node:main',
            'safety_watchdog_node = onnx_cone_detect.safety_watchdog_node:main',
        ],
    },
)
