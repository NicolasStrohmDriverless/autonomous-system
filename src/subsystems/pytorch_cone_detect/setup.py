# src/subsystems/pytorch_cone_detect/setup.py
import os
...
package_name = 'pytorch_cone_detect'
...
setup(
    ...
    install_requires=['setuptools', 'sort_tracking', 'art_slam'],
    zip_safe=True,
    ...
    entry_points={
        'console_scripts': [
            ...
            'watchdog_node = pytorch_cone_detect.watchdog_node:main',
            'safety_watchdog_node = pytorch_cone_detect.safety_watchdog_node:main',
        ],
    },
)
