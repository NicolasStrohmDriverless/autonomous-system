# src/subsystems/random_cone_detect/setup.py
import os
...
package_name = "random_cone_detect"
...
setup(
    name=package_name,
    version="0.0.1",
    # findet automatisch random_cone_detect und alle Unter-Module (inkl. utils.py)
    ...
    data_files=[
        ...
        # 3) launch files
        (f"share/{package_name}/launch", list_rel_files("launch")),
        # 4) config files
    ...
    entry_points={
        "console_scripts": [
            ...
            "manual_control_node   = random_cone_detect.manual_control_node:main",
        ],
    },
)
