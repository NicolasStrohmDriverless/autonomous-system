...
#include "oak_cone_detect_interfaces/msg/detail/cone3_d__rosidl_typesupport_fastrtps_c.h"
...
using _Cone3D__ros_msg_type = oak_cone_detect_interfaces__msg__Cone3D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Cone3D__ros_msg_type * ros_message = static_cast<const _Cone3D__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Cone3D__ros_msg_type * ros_message = static_cast<_Cone3D__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Cone3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_oak_cone_detect_interfaces__msg__Cone3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = oak_cone_detect_interfaces__msg__Cone3D;
    is_plain =
      (
...
static size_t _Cone3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_oak_cone_detect_interfaces__msg__Cone3D(
...
static message_type_support_callbacks_t __callbacks_Cone3D = {
...
static rosidl_message_type_support_t _Cone3D__type_support = {
