...
bool oak_cone_detect_interfaces__msg__cone2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("oak_cone_detect_interfaces.msg._cone2_d.Cone2D", full_classname_dest, 46) == 0);
  }
  oak_cone_detect_interfaces__msg__Cone2D * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Cone2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("oak_cone_detect_interfaces.msg._cone2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Cone2D");
