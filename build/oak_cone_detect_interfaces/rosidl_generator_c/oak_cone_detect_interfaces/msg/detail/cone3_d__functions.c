...
oak_cone_detect_interfaces__msg__Cone3D__init(oak_cone_detect_interfaces__msg__Cone3D * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->id)) {
    oak_cone_detect_interfaces__msg__Cone3D__fini(msg);
    return false;
  }
  // label
...
oak_cone_detect_interfaces__msg__Cone3D__create()
{
  ...
  oak_cone_detect_interfaces__msg__Cone3D * msg = (oak_cone_detect_interfaces__msg__Cone3D *)allocator.allocate(sizeof(oak_cone_detect_interfaces__msg__Cone3D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(oak_cone_detect_interfaces__msg__Cone3D));
  bool success = oak_cone_detect_interfaces__msg__Cone3D__init(msg);
  if (!success) {
...
oak_cone_detect_interfaces__msg__Cone3D__Sequence__init(oak_cone_detect_interfaces__msg__Cone3D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  oak_cone_detect_interfaces__msg__Cone3D * data = NULL;

  if (size) {
    data = (oak_cone_detect_interfaces__msg__Cone3D *)allocator.zero_allocate(size, sizeof(oak_cone_detect_interfaces__msg__Cone3D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = oak_cone_detect_interfaces__msg__Cone3D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        oak_cone_detect_interfaces__msg__Cone3D__fini(&data[i - 1]);
      }
...
oak_cone_detect_interfaces__msg__Cone3D__Sequence__fini(oak_cone_detect_interfaces__msg__Cone3D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      oak_cone_detect_interfaces__msg__Cone3D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  oak_cone_detect_interfaces__msg__Cone3D__Sequence * array = (oak_cone_detect_interfaces__msg__Cone3D__Sequence *)allocator.allocate(sizeof(oak_cone_detect_interfaces__msg__Cone3D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = oak_cone_detect_interfaces__msg__Cone3D__Sequence__init(array, size);
  if (!success) {
...
oak_cone_detect_interfaces__msg__Cone3D__Sequence__destroy(oak_cone_detect_interfaces__msg__Cone3D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    oak_cone_detect_interfaces__msg__Cone3D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
oak_cone_detect_interfaces__msg__Cone3D__Sequence__are_equal(const oak_cone_detect_interfaces__msg__Cone3D__Sequence * lhs, const oak_cone_detect_interfaces__msg__Cone3D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!oak_cone_detect_interfaces__msg__Cone3D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  oak_cone_detect_interfaces__msg__Cone3D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(oak_cone_detect_interfaces__msg__Cone3D);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    oak_cone_detect_interfaces__msg__Cone3D * data =
      (oak_cone_detect_interfaces__msg__Cone3D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!oak_cone_detect_interfaces__msg__Cone3D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          oak_cone_detect_interfaces__msg__Cone3D__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!oak_cone_detect_interfaces__msg__Cone3D__copy(
